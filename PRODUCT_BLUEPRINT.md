...
**Budgets.** Defaults: 20 queries, 80 pages, 420 s (`RESEARCH_MAX_*`), `WEB_MAX_ROUNDS=3`, `WEB_RESULTS_PER_QUERY=6`, `WEB_PAGES_PER_QUERY=5`, `SOCIAL_MAX_ATTEMPTS=6`, `SOCIAL_TARGET_ON_TOPIC=25`. Query gap 6 s keyless / 0.5 s keyed. One active run per session; a new start supersedes the old.
