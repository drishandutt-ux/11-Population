...
| Method | Path | Purpose |
|---|---|---|
| GET | `/lab/instruments` | The instrument library — key, label, description, question, **`inputs`** (the tool's own declared controls), **`kpis`**, `page`, answer schema. The single source of truth both sides read: the UI builds its form and its headline strip from this. |
...
│   │                                #   auth_test, evidence_test, measurement_test,
