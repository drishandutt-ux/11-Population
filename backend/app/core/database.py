...
async def create_tables():
    ...
    import app.models.kg, app.models.profile, app.models.evidence, app.models.measurement, app.models.population, app.models.scoping, app.models.archetype  # noqa: F401 — make sure every model is registered on Base
    if _sqlite:
...
async def _ensure_columns():
    ...
    migrations = [
        ...
        "ALTER TABLE spawned_agents ADD COLUMN weight FLOAT",
        "ALTER TABLE population_builds ADD COLUMN frame JSON",
