...
from app.api.v1 import sessions, ingestion, simulation, agents, reports, presets, users, research, measurement, population, scoping, archetypes
...
app.include_router(scoping.router, prefix="/api/v1")
